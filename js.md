...
## Синтаксис объявления функции. Вызов функции. Пример: функцию, создающую 5 однотипных блоков-заголовков (`<h2></h2>`) с надписями Header 1 … Header 5.
`document.write("<h2> Header "+i+ "</h2>")`

## Параметры функции

## Возвращаемое значение функции. Ключевое слово return. 
Разобрать несколько методов:
