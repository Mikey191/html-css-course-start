...
2. Общие стили для всех элементов
Уберите отступы и паддинги.
Установите box-sizing: border-box для всех элементов.

3. Стили для body
Установите шрифт Oswald, sans-serif.
Задайте фон сайта светло-серым: background-color: #f2f2f2.
Цвет текста сделайте темно-серым: color: #333.

4. Общие стили для ссылок
Уберите подчеркивание: text-decoration: none.
Цвет сделайте наследуемым от родителя: color: inherit.

5. Общие стили для списков
Уберите маркеры списка: list-style-type: none.

6. Стили для хедера .header
Горизонтальное выравнивание: display: flex.
Распределите элементы: justify-content: space-between.
Выравнивание по вертикали: align-items: center.
Сделайте хедер «липким» (position: sticky) и закрепите сверху (top: 0).
Добавьте внутренние отступы: padding: 15px 30px.
Установите фон темно-серым: background-color: #333.
Задайте цвет текста белым: color: #f2f2f2.
Установите z-index для перекрытия других элементов: z-index: 100.

7. Стили для логотипа в хедере .header-logo img
Установите высоту изображения логотипа: height: 40px.

8. Стили для заголовка .header-title h1
Установите шрифт Roboto.
Сделайте текст жирным (font-weight: bold) и увеличьте его размер (font-size: 24px).
Задайте верхний регистр для текста: text-transform: uppercase.

9. Стили для навигации .navigation
- Настройте списки как горизонтальные:
  - Установите display: flex.
  - Добавьте отступы между пунктами: gap: 20px.
- Стили для ссылок внутри навигации:
  - Сделайте цвет текста белым: color: #f2f2f2.
  - Добавьте жирный шрифт: font-weight: bold.
  - Добавьте паддинг: padding: 5px.
- При наведении (:hover) измените цвет на золотой (#ffcc00) и добавьте подчеркивание.
- Для первого элемента (:first-of-type) сделайте ссылку выделенной: золотой текст и подчеркивание.

10. Стили для фильтров .filters
- Задайте position: sticky и закрепите сверху на расстоянии 30px (top: 30px).
- Установите фон темно-серым: background-color: #444.
- Добавьте внутренние отступы: padding: 10px 30px.
- Стили для заголовка:
  - Установите нижний отступ: margin-bottom: 10px.
- Стили для списка фильтров:
  - Используйте display: flex и добавьте отступы между элементами: gap: 15px.
- Для ссылок добавьте цвет белого текста, а при наведении изменяйте цвет на золотой.
