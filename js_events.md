...
| Событие      | Когда использовать                                                      | Пример реальной задачи                                |
| ------------ | ----------------------------------------------------------------------- | ----------------------------------------------------- |
...
### Пример 2: Изменение размера блока с помощью стрелок
...
### Почему мы используем `box.offsetWidth` и `box.offsetHeight`, а не `box.style.width` и `box.style.height`
