...
**Панель поиска**:
<img src="img/lesson8/GoogleFontSearch.jpg" width="500">

**Язык шрифта**:
<img src="img/lesson8/GoogleFontLang.jpg" width="500">

**Название шрифта**:
<img src="img/lesson8/GoogleFontFont-family.jpg" width="500">
...
**Кнопка `Get Font`**:
<img src="img/lesson8/GoogleFontGetFont.jpg" width="500">

**Кнопка `hide selected families`**:
<img src="img/lesson8/GoogleFontlistHideSelectedFamilies.jpg" width="500">

- Перейдя в эту панель будут две кнопки для **Добавления шрифта с помощью ссылки** и **Скачивания шрифта на ваш компьютер**.

<img src="img/lesson8/GoogleFontLinkDownload.jpg" width="500">
